...
public class Leinwand
{
   ...
   * @param  shape  ein Objekt der Klasse Shape, das tatsaechlich
   *                 gezeichnet wird
   */
   ...
   * die tatsaechlich im Leinwand-Fenster angezeigt wird. Diese Klasse
   * definiert ein JPanel mit der zusaetzlichen Moeglichkeit, das auf ihm
